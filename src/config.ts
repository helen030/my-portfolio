export const siteConfig = {
  ...
  aboutMe: [
    ...
    "I have also completed two internships at Aurecon and TL Consulting, where I gained valuable experience in consulting, asset management, and operational transformation.", 
    "I am excited and confident to solve real-world business problems and draw useful insights that help businesses improve their performance.",   
  ],
